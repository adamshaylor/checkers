...
var $author$project$Main$Man = {$: 'Man'};
var $author$project$Main$NonPlaying = {$: 'NonPlaying'};
...
var $author$project$Main$Vacant = {$: 'Vacant'};
...
var $author$project$Main$size = 8;
var $author$project$Main$playingSquaresPerRow = ($author$project$Main$size / 2) | 0;
...
var $author$project$Main$makeRow = F2(
	function (square1, square2) {
		var pairs = A2(
			...
			$author$project$Main$playingSquaresPerRow,
			_List_fromArray(
				[square1, square2]));
		return $elm$core$List$concat(pairs);
	});
var $author$project$Main$init = function () {
	var whitesStartingRows = $elm$core$List$concat(
		_List_fromArray(
			[
				A2(
				$author$project$Main$makeRow,
				$author$project$Main$Occupied(
					A2($author$project$Main$Piece, $author$project$Main$White, $author$project$Main$Man)),
				$author$project$Main$NonPlaying),
				A2(
				$author$project$Main$makeRow,
				$author$project$Main$NonPlaying,
				$author$project$Main$Occupied(
	...
	var vacantRows = $elm$core$List$concat(
		_List_fromArray(
			[
				A2($author$project$Main$makeRow, $author$project$Main$Vacant, $author$project$Main$NonPlaying),
				A2($author$project$Main$makeRow, $author$project$Main$NonPlaying, $author$project$Main$Vacant)
			]));
	var redsStartingRows = $elm$core$List$concat(
		_List_fromArray(
			[
				A2(
				$author$project$Main$makeRow,
				$author$project$Main$NonPlaying,
				$author$project$Main$Occupied(
					A2($author$project$Main$Piece, $author$project$Main$Red, $author$project$Main$Man))),
				A2(
				$author$project$Main$makeRow,
				$author$project$Main$Occupied(
					A2($author$project$Main$Piece, $author$project$Main$Red, $author$project$Main$Man)),
	...
	return {
		board: $elm$core$List$concat(
			_List_fromArray(
				[redsStartingRows, vacantRows, whitesStartingRows])),
		moves: _List_Nil
	};
}();
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var moves = _Utils_ap(
			...
			_List_fromArray(
				[msg]));
		return {board: model.board, moves: moves};
	});
...
var $author$project$Main$boardToRows = function (squares) {
	return A2($elm_community$list_extra$List$Extra$groupsOf, $author$project$Main$size, squares);
};
var $elm$html$Html$td = _VirtualDom_node('td');
var $author$project$Main$renderSquare = function (square) {
...
var $author$project$Main$renderRow = function (squares) {
	var renderedSquares = A2($elm$core$List$map, $author$project$Main$renderSquare, squares);
	return A2($elm$html$Html$tr, _List_Nil, renderedSquares);
};
var $elm$html$Html$table = _VirtualDom_node('table');
var $author$project$Main$view = function (model) {
	var rows = $author$project$Main$boardToRows(model.board);
	var renderedRows = A2($elm$core$List$map, $author$project$Main$renderRow, rows);
	return A2($elm$html$Html$table, _List_Nil, renderedRows);
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Main$init, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"List.List Basics.Int","aliases":{},"unions":{"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}}}}})}});
...
},{"./src/Main.elm":"src/Main.elm"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/checkers.e31bb0bc.js.map